...
struct header_struct header={"head",0,muestras_hola,44100,"tail"}; //atencion que enviando todo el tiempo 3 floatas, no me da para ir mas alla de 4k
...
int main ( void ) {
	...
	for(i=0;i<muestras_hola;i++) {
		signal[i]=(float)hola[i]/50.0;
	}
